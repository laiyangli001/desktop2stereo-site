...
func resetChannelAffinityUsageCacheStatsForTest(t *testing.T, ruleName, usingGroup, keyFP string) {
	t.Helper()
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	...
	resetChannelAffinityUsageCacheStatsForTest(t, ruleName, usingGroup, keyFP)
